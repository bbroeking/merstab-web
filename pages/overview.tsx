    ...
    return <div>
        ...
        <Col className={styles.main}>
            ...
            <div className={styles.text}>Merstab aims to provide market stability for the emerging DeFi industry. During the summer we have seen one of the largest market crashes in the history of Crypto markets. Mainly caused by derivatives. Thus, we aim to bring stability to the derivatives market.
                The solution is an on-chain market maker for decentralized derivatives exchanges which makes use of sophisticated market-making algorithms from the traditional finance industry. The current model of AMMs and liquidity pools aren't capital efficient and pose many risks to investors.</div>
